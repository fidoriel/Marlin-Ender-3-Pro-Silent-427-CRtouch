...
#define STRING_CONFIG_H_AUTHOR "(fidoriel, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Lucas Ender3Pro"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-44, -2, -0.8 }
